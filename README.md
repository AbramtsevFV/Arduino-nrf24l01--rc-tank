...
- Лазерный модуль для башни TZT KY-008. 
### Добавлено
В проект добавлено мигание светодиодом, который показывает состояние танка, мигание дыхание указывает на отсутствие сигнала, частое мигание указывает на состояние готовности и сигнал получет от пульта. На данный момент это реализовано на milles, так как не хватило пинов ШИМ, но заказан модуль PCA9685PW, тогда переделаю на шим, сами функции мигания на ШИМ в проекте тоже есть. 
